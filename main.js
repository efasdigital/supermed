...
function carregarDependentes(){
  ...
  dependentes.forEach((el)=>{
    ...
    let dependente_container = `<div class="dependente" data-id="${identificador}">
                                  <input class="nome" placeholder="Digite o nome do beneficiário" type="text" value="${nome}"/>
                                  <input class="idade" placeholder="Digite a idade do beneficiário" type="number" value="${idade}"/>
                                  <div class="action">
